	...
	implements Serializable, Comparable, Cloneable
{
	...
	*/
	...
	{
		return this.add(new DoubleDouble(y));
	}
	...
	*/
	...
	{
		return this.subtract(new DoubleDouble(y));
	}
...
*/
	...
	{
		return this.multiply(new DoubleDouble(y));
	}
	...
	{
		return this.divide(new DoubleDouble(y));
	}
